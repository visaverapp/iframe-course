      ...
      <div
        ...
        <div className={`${!isChangedHeight ? 'h-[93vh]' : 'h-[85vh]'} scroll-bar overflow-y-scroll`}>
          <div className='flex justify-between'>
            ...
            <div onClick={getSummaryHandle}
                 className='cursor-pointer w-[40px] h-[40px] bg-[#00B856] rounded-[13px] content-evenly pl-[8px]'>
              <Download/>
            </div>
          </div>
          <div className='w-[590px]'>
            <p className='pb-[10px] text-dark-blue font-open-sans text-[14px] font-normal'>Стратегия выхода на рынок
              нужна
              для
            ...
            <ol className='pb-[10px] text-dark-blue font-open-sans text-[14px] font-normal'>Стратегия помогает:
              ...
              <li className='text-dark-blue font-open-sans text-[14px] font-normal'>• сформулировать миссию компании.
              </li>
            </ol>
            <p className='pb-[20px] text-dark-blue font-open-sans text-[14px] font-normal'>Также стратегия — это
              документ,
              который
            ...
            <h3 className='pb-[10px] text-dark-blue font-open-sans text-[14px] font-bold'>Стратегии продвижения на
              рынке</h3>
            <ol className='pb-[10px] text-dark-blue font-open-sans text-[14px] font-normal'>Существует четыре типа
              рынка:
              ...
              <li className='text-dark-blue font-open-sans text-[14px] font-normal'>• где есть несколько крупных
                игроков.
              </li>
            </ol>
            ...
            <ul className='pb-[10px]'>
              ...
              <li className='text-dark-blue font-open-sans text-[14px] font-normal'>4.<span
                  className='text-dark-blue font-open-sans text-[14px] font-bold'> Рынок, где есть крупные игроки с большими инвестициями:</span> можно
                предложить то, чего ещё нет у конкурентов.
              </li>
            </ul>
            <p className='pb-[10px] text-dark-blue font-open-sans text-[14px] font-bold'>Построение стратегии начинается
              с
              анализа
            ...
            <ol className='pb-[10px] text-dark-blue font-open-sans text-[14px] font-bold'>Для расчёта индекса
              лояльности
              ...
              <li className='text-dark-blue font-open-sans text-[14px] font-normal'>2.Что нам нужно улучшить в
                следующий
                раз,
                чтобы получить от вас 10?
              </li>
            </ol>
            <ul className='pb-[10px] text-dark-blue font-open-sans text-[14px] font-bold'>Ответы делятся на три
              категории:
              <li className='text-dark-blue font-open-sans text-[14px] font-normal'>• Сторонники — те, кто поставил 9
                или
                10
                баллов.</li>
              <li className='text-dark-blue font-open-sans text-[14px] font-normal'>• Нейтральные — 7 или 8 баллов.
              </li>
            ...
            <p className='text-dark-blue font-open-sans text-[14px] font-normal pb-[8px]'>Также можно использовать
              индустриальные
